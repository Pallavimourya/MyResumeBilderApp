...
class Resume extends JFrame implements ActionListener {
    ...
    // panel
    JFrame p=new JFrame("Created By Pallavi Mourya- Online Resume Builder");
    JComboBox cb;
    // constructor
    Resume()
    {
        ...
        linkedln.setBounds(700,160, 200,30);  
        github.setBounds(700,210, 200,30);  
        hackerrnk.setBounds(700,260, 200,30);  
        contact.setBounds(700,310, 200,30);
        ...
        linkedlnJLabel.setBounds(500, 160, 150, 30);
        githubJLabel.setBounds(500, 210, 150, 30);
        hackerJLabel.setBounds(500, 260, 150, 30);
        contactJLabel.setBounds(500, 310, 150, 30);
